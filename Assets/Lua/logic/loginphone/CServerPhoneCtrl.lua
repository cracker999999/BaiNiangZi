...
CServerPhoneCtrl.g_DevServer = {
	servers = {
		...
		--个人服务器10.254.7.30
		-- [1001]={id=1001, name="群星璀璨（新区）", ip="10.254.7.30", new=1, serverindex=9999-1001},
		-- 新建的服务器
		 [1001]={id=1001, name="群星璀璨（新区）", ip="82.156.187.184", new=1, serverindex=9999-1001},    --测试服
		 --[1001]={id=1001, name="一区（2022.10.25）", ip="123.99.197.51", new=1, serverindex=9999-1001},  --正式服
