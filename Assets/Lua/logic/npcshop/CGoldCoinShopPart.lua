...
function CGoldCoinShopPart.InitShopTabs(self)
    ...
    local lTabInfo = {
        ...
        [4] = {id = 304, name = "仙玉商城", sysName = define.System.StoreSys304},
        [5] = {id = 305, name = "无级别商城", sysName = define.System.StoreSys305},
        [6] = {id = 306, name = "宝石商城", sysName = define.System.StoreSys306},
    }
