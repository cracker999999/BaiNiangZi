...

	{
...

	   {
		...
		btnInfo = {
			...
			{name = "8仙玉大礼", param = "huodongop charge 201"},
			{name = "25仙玉大礼", param = "huodongop charge 202"},

			{name = "领取仙玉大礼", param = "huodongop charge 203"},
			{name = "离线发放仙玉大礼", param = "huodongop charge 204"},
			{name = "刷天", param = "huodongop charge 205"},
			{name = "68一本万利", param = "huodongop charge 301"},

			{name = "98一本万利", param = "huodongop charge 302"},
			{name = "领取等级仙玉", param = "huodongop charge 303 {类型，等级}"},
...

	{
...

	   {
		...
		btnInfo = {
			...
			{name = "仙玉领取", param = "huodongop activepoint 108 {point_key = 1}"},
			...
			{name = "仙玉狂欢", param = "huodongop goldcoinparty 100"},
			{name = "仙玉狂欢开始", param = "huodongop goldcoinparty 101 {day=7}"},
			{name = "仙玉狂欢结束", param = "huodongop goldcoinparty 102"},
