...
function CRechargeGoldCoinItem.SetBoxInfo(self, datalist)
    ...
    self.m_TitleLabel:SetText(string.AddCommaToNum(datalist.gold_coin_gains) .. "仙玉" .. sName)

    self.m_FirstRewardLabel:SetText(string.format("每日赠送%s仙玉，持续%s天", string.ConvertToArt(datalist.reward_gold_coin), sDay))
