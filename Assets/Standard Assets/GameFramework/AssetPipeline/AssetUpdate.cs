...
namespace AssetPipeline
{
    public class AssetUpdate : MonoBehaviour
    {
        ...
        public void LoadStaticConfig(string configName, Action<string> onLoadFinish, Action<string> onError)
        {
            ...
            //url = "https://clxy001.oss-cn-hangzhou.aliyuncs.com/bnz/release/android/servers/staticconfig.txt?ver=637980759964452001";
        ...
        {
            PrintInfo("检查VersionConfig游戏版本更新");
        ...
        {
            return true;
            if (!IsSupportUpdateDllPlatform()) return true;
