...
public static class ProjectIconSetting
{
    ...
    public static void LoadSettingData()
    {
        ...
        if (jsonData.Keys.Contains(Key_FrameworkVersion))
        {
            ...
            Debug.Log("ProjectIconConfig FrameworkVersion = " + GameSetting.csrooturlid);
        }
        ...
        if (jsonData.Keys.Contains(Key_ChannelAreaFlag))
        {
            ...
            Debug.Log("ProjectIconConfig channelAreaFlag = " + channelAreaFlag);
        }
        ...
        if (jsonData.Keys.Contains(Key_ad_app_id_ios))
        {
            ...
            Debug.Log("ProjectIconConfig ad_app_id_ios = " + GameSetting.ad_app_id_for_ios);
        }
        ...
        if (jsonData.Keys.Contains(Key_ad_activity_id_ios))
        {
            ...
            Debug.Log("ProjectIconConfig ad_activity_id_ios = " + GameSetting.ad_activity_id_for_ios);
        }
        ...
        if (jsonData.Keys.Contains(Key_trackingIO_appId))
        {
            ...
            Debug.Log("ProjectIconConfig trackingIO_appId = " + GameSetting.trackingIO_appId);
        }
