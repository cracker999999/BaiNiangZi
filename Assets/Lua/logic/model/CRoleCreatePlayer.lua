...
function CRoleCreatePlayer.ctor(self, oRoleconfigid)
	...
	self.m_WeaponIdxHashList = {1, 1, 7, 7, 8, 9, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil}--新添加角色：QQ770239839
	self.m_WeaponAnimHashList = {1, 1, nil, nil, 2, 9, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil}--新添加角色：QQ770239839
