...
public class UnityEngine_ApplicationWrap
{
	...
	static int GetStackTraceLogType(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.LogType arg0 = (UnityEngine.LogType)(int)LuaDLL.lua_tonumber(L, 1);
	...
	static int SetStackTraceLogType(IntPtr L)
	{
		try
		{
			...
			UnityEngine.LogType arg0 = (UnityEngine.LogType)(int)LuaDLL.lua_tonumber(L, 1);
			UnityEngine.StackTraceLogType arg1 = (UnityEngine.StackTraceLogType)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int RequestUserAuthorization(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.UserAuthorization arg0 = (UnityEngine.UserAuthorization)(int)LuaDLL.lua_tonumber(L, 1);
