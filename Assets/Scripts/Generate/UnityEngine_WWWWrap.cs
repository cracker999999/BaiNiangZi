...
using System;
using LuaInterface;using UnityEngine;
...
public class UnityEngine_WWWWrap
{
	...
	static int GetAudioClip(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.WWW), typeof(bool), typeof(bool), typeof(int)))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
				bool arg1 = LuaDLL.lua_toboolean(L, 3);
				UnityEngine.AudioType arg2 = (UnityEngine.AudioType)(int)LuaDLL.lua_tonumber(L, 4);
	...
	static int GetAudioClipCompressed(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.WWW), typeof(bool), typeof(int)))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
				UnityEngine.AudioType arg1 = (UnityEngine.AudioType)(int)LuaDLL.lua_tonumber(L, 3);
	...
	static int get_responseHeaders(IntPtr L)
	{
		...
		try
		{
            ...
            ToLua.PushTable(L, obj.responseHeaders);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int set_threadPriority(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.WWW obj = (UnityEngine.WWW)o;
			UnityEngine.ThreadPriority arg0 = (UnityEngine.ThreadPriority)(int)LuaDLL.lua_tonumber(L, 2);
