--package.cpath = package.cpath .. ';C:/Users/Leen/.Rider2019.3/config/plugins/intellij-emmylua/classes/debugger/emmy/windows/x64/?.dll'
...
local breakSocketHandler = false
local function OpenVsCodeDebug(ip, port)
	ip = ip or "localhost"
	port = port or 7003
	local bsHandler, debugXpCall = require("LuaDebugjit")(ip, port)
	breakSocketHandler = bsHandler
	breakSocketHandler()
end
--C#回调 
function main.start()
