...
namespace AssetPipeline
{
    ...
    public class AssetBundleBuilder : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.BeginVertical(GUILayout.MaxWidth(420f)); //Left Cotent Begin
            _leftContentScroll = EditorGUILayout.BeginScrollView(_leftContentScroll);
            {
                ...
                EditorGUILayout.BeginVertical("HelpBox");
                {
                    ...
                    _forceUpdate = EditorGUILayout.Toggle("强制更新", _forceUpdate);
...
//					EditorGUILayout.EndHorizontal();
        ...
        private bool _resetAssetbundleName = false;
        ...
        private void UpdateVersion()
        {
            ...
            if (EditorUtility.DisplayDialog("制作补丁", tip, "开始制作", " 取消"))
            {
                EditorApplication.delayCall += () =>
                {
                    ...
                    data.resVersion = _patchResVersion;
                    data.forceUpdate = _forceUpdate;
                    FileHelper.SaveJsonObj(data, GetExportPlatformPath() + "/versionConfig.json");
                    FileHelper.SaveJsonObj(data, GetExportPlatformPath() + "/versionConfigTest.json");
...
//					|| resGroup == ResGroup.Audio
        ...
        private void GeneratePackageBundle(bool isMiniRes)
        {
            ...
            {
                if(dir.Contains("WASGame")) continue;
            ...
            {
                if(file.Contains("WASGame")) continue;
        ...
        public static void BuildWinTest()
        {
            ...
            AssetBundleBuilder.Instance.GeneratePackageBundle(false);//GenerateTotalRes
