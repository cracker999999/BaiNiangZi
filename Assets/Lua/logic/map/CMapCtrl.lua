...
function CMapCtrl.CheckPosArea(self, oWalker, posInfo)--服务端地图范围
	local posx, posy = 12, 12
	if posInfo and posInfo.x and posInfo.x > 0 and posInfo.x < 200 then--服务端地图范围
...
function CMapCtrl.CheckSummonPosArea(self, oWalker, posInfo)   --服务端地图范围
	local posx, posy = 12, 12
	if posInfo and posInfo.x and posInfo.x > 0 and posInfo.x < 200 then--服务端地图范围
		posx, posy = posInfo.x, posInfo.y
	else
