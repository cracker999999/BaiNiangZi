...
DATA={
	...
	[1110]={
		...
		["1102"]={
			[1]={action=[[attack1]],end_frame=15,hit_frame=14,speed=1,start_frame=0,},
			[2]={action=[[attack2]],end_frame=20,hit_frame=0,speed=1,start_frame=8,},
			[3]={action=[[magic]],end_frame=35,hit_frame=0,speed=1,start_frame=7,},
		},
		["11021"]={
			[1]={action=[[attack1]],end_frame=15,hit_frame=14,speed=1,start_frame=0,},
			[2]={action=[[attack2]],end_frame=20,hit_frame=0,speed=1,start_frame=8,},
	...
	[5115]={["5115"]={[1]={action=[[attack1]],end_frame=16,speed=1,start_frame=0,},},},
}
