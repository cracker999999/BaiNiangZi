...
public class UnityEngine_TransformWrap
{
	...
	static int Translate(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(UnityEngine.Vector3), typeof(int)))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Space arg1 = (UnityEngine.Space)(int)LuaDLL.lua_tonumber(L, 3);
				obj.Translate(arg0, arg1);
				return 0;
			}
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(float), typeof(float), typeof(float), typeof(int)))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 4);
				UnityEngine.Space arg3 = (UnityEngine.Space)(int)LuaDLL.lua_tonumber(L, 5);
				obj.Translate(arg0, arg1, arg2, arg3);
				return 0;
			}
			else
	...
	static int Rotate(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(UnityEngine.Vector3), typeof(float), typeof(int)))
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.Space arg2 = (UnityEngine.Space)(int)LuaDLL.lua_tonumber(L, 4);
	...
	static int DOBlendableLocalRotateBy(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
			DG.Tweening.RotateMode arg2 = (DG.Tweening.RotateMode)(int)LuaDLL.lua_tonumber(L, 4);
	...
	static int DOLocalPath(IntPtr L)
	{
		try
		{
			...
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
			DG.Tweening.PathType arg2 = (DG.Tweening.PathType)(int)LuaDLL.lua_tonumber(L, 4);
			DG.Tweening.PathMode arg3 = (DG.Tweening.PathMode)(int)LuaDLL.lua_tonumber(L, 5);
	...
	static int DOLookAt(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
			DG.Tweening.AxisConstraint arg2 = (DG.Tweening.AxisConstraint)(int)LuaDLL.lua_tonumber(L, 4);
